  ...
  <div class="row">
    ...
    <li>
           <div class="row"><div class="col-xs-3">
            <div class="avatar">
                <img  src="<%=request.getContextPath()%>/images/Friends/guy-2.jpg" alt="img" class="img-circle img-no-padding img-responsive">
           </div></div>
      <div class="col-xs-9">
    ...
    <li>
     <div class="row"><div class="col-xs-3">
     <div class="avatar">
     <img src="images/Friends/woman-2.jpg" alt="img" class="img-circle img-no-padding img-responsive">
     </div></div>
     <div class="col-xs-9">
    ...
    <img src="images/Friends/woman-3.jpg" alt="Circle Image" class="img-circle img-no-padding img-responsive">
    </div></div>
    <div class="col-xs-9">
    ...
    <div class="row">
    <div class="col-xs-3"><div class="avatar">
    <img src="images/Friends/woman-4.jpg" alt="Circle Image" class="img-circle img-no-padding img-responsive">
    </div></div>
    <div class="col-xs-9">
  ...
  <div class="col-md-12">
   ...
   <div class="box-comment">
    <img class="img-circle img-sm" src="images/Friends/woman-3.jpg" alt="User Image">
    <div class="comment-text">
   ...
   <div class="col-md-12"> 
    ...
    <div class="box-tools">
     ...
     <img class="img-responsive pad" src="images/Photos/8.jpg" alt="Photo">
