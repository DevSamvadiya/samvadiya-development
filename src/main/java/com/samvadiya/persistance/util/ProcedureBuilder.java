...
public class ProcedureBuilder extends StoredProcedure{
  public ProcedureBuilder(DataSource datasource,String sprocName,List<StoreProcParameters> sqlInParam,List<StoreProcParameters> sqlOutParam,List<StoreProcParameters> sqlResulstParam)throws Exception 
    {
